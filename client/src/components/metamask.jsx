      ...
      return(
        <React.Fragment>
          <div className="jumbotron text-center">
            ...
            <img style={{maxWidth:'50%'}} className="img-fluid" src={require('../assets/metamask_install.png')} alt="metamask_install.png"/></a>
            <hr className="my-4"/>
      ...
      return(
        <React.Fragment>
          <div className="jumbotron text-center">
            ...
            <a href="https://metamask.io/" target="_blank" rel="noopener noreferrer">
            <img style={{maxWidth:'20%'}} className="img-fluid" src={require('../assets/metamask_login.png')} alt="metamask_login.png"/></a>
          </div>
        </React.Fragment>
      );
    }
